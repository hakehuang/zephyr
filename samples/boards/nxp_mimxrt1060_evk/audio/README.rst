...
MIMXRT1060_EVK from NXP with control from a Linux host connected
over USB.
...
evk board is the master on the I2S interfaces.
...
This application uses an NXP MIMXRT1060_EVK board

Building
********

.. zephyr-app-commands::
   :zephyr-app: samples/boards/nxp_mimxrt1060_evk/audio
   :board:
   :goals: build
   :compact:
