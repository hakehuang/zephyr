...
I2S Audio Sample Application
#########################################

Overview
********

This sample application demonstrates audio playback on an NXP MIMXRT1060_EVK.
...
EVK board is the master on both I2S interfaces.
...
This application uses an MIMXRT1060_EVK Board
...
.. zephyr-app-commands::
   :zephyr-app: samples/boards/nxp_mimxrt1060_evk/i2s
   :board:
   :goals: build
...
Console output (Tone Playback from EVK)
-----------------------------------------
