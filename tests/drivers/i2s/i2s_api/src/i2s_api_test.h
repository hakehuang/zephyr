...
#ifdef CONFIG_BOARD_MIMXRT1060_EVK
#define TX_I2S_OPTIONS (I2S_OPT_FRAME_CLK_SLAVE | I2S_OPT_BIT_CLK_MASTER)
#define RX_I2S_OPTIONS (I2S_OPT_FRAME_CLK_SLAVE | I2S_OPT_BIT_CLK_MASTER)
#define NO_LOOP_BACK 1
#else
#define TX_I2S_OPTIONS (I2S_OPT_FRAME_CLK_SLAVE | I2S_OPT_BIT_CLK_SLAVE)
#define RX_I2S_OPTIONS (I2S_OPT_FRAME_CLK_SLAVE | I2S_OPT_BIT_CLK_SLAVE)
#endif
